export const myProjects = [
...

  {
    ...
    description:
      "build by BootStrap & Css  (Response)",
...

  {
    ...
    description:
      "Build by FrameWork Vuetify  &  Vue.js",
  ...
  },
  {
    ...
    projectTitle: "Bulma Freash", category: ['bulma' ,"bootstrap"],

    imPath: "./images/Bulma.png",
    description:
      "Build By frameWork CSs Bulma ",
...

  {
    ...
    projectTitle: "My Cv", category: ['bootstrap', 'css']

    , imPath: "./images/cv.png",
    description:
      "Build By BootStrap And Some Library (Response)",
  ...
  },
  {
    ...
    projectTitle: "Mini Market", category: ['bootstrap'],
